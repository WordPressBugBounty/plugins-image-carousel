...
function icp_menu_page() {
	...
	add_menu_page( 'Carousel Settings', 'Image Carousel', 'manage_options', 'icp-carousel-settings', 'icp_settings_page', 'dashicons-images-alt2', 21 );
    ...
    <div id="option-tree-settings-api">
        <div class="ui-tabs ui-widget ui-widget-content ui-corner-all">
            <ul >
                ...
                <li class="icp_tab_items" id="icp-docs"><a href="#section_documentation">Documentation</a></li>
